...
class SectionController extends AbstractController
{
    ...
    {
        return $this->render('back/section/index.html.twig', [
    ...
    public function new(Request $request, SectionRepository $sectionRepository): Response
    {
        ...
        return $this->renderForm('back/section/new.html.twig', [
            'section' => $section,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back/section/show.html.twig', [
            'section' => $section,
        ]);
    }
