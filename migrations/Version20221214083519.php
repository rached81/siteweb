 ...
 */
final class Version20221214083519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE time_line ADD time_line_topic_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_7CA9BDDB44E722C8 ON time_line (time_line_topic_id)');
    }
