 ...
 */
final class Version20220530145406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE time_line (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, step_date DATE NOT NULL, description LONGTEXT NOT NULL, icon LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', published TINYINT(1) DEFAULT NULL, article VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
