 ...
 */
final class Version20220405132904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE created_at created_at DATE NOT NULL, CHANGE update_at update_at DATE NOT NULL');
    }
