 ...
 */
final class Version20221209130953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE time_line ADD category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE time_line ADD CONSTRAINT FK_7CA9BDDB12469DE2 FOREIGN KEY (category_id) REFERENCES categorie (id)');
        $this->addSql('CREATE INDEX IDX_7CA9BDDB12469DE2 ON time_line (category_id)');
    }
